...
1. Commit your changes using a descriptive commit message. Adherence to these conventions
...
mit your changes using a descriptive commit messagmit your changes using a descriptive commit messag
...
1. In GitHub, send a pull request to `nimb3s:master`.
